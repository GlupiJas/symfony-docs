    ...
    As an example you'll create a price filter to format a given number into price::
        ...
        class AppExtension extends \Twig_Extension
        {
            ...
            {
                return array(
                    new \Twig_SimpleFunction('', array($this, 'customFunction')), // custom function
                    new \Twig_SimpleFunction('trim', 'trim'), // native php function
                );
            }
            ...
            public function customFunction($something){
